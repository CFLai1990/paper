...
\begin{figure}[htbp]
\centering
\subfloat[Datum Suggestion]{\includegraphics[width=0.47\linewidth]{images/suggestion_point.eps}}
\subfloat[Cluster Suggestion]{\includegraphics[width=0.50\linewidth]{images/suggestion_group.eps}}
